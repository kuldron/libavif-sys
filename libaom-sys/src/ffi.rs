...
#[doc = "Codec control function to set the reference frame config,\n aom_svc_ref_frame_config_t* parameter"]
...
pub struct aom_svc_ref_frame_config {
    ...
    #[doc = " Buffer slot index (0..7) for each of 7 references indexed above."]
